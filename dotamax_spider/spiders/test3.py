...
LOGIN_URL = 'https://testserver.comein.cn/ComeinManager/loginView'
...
my_cookie = {}
my_cookie['JSESSIONID'] = '81444267-8da8-46c2-ab50-fbd0a4f0a071'
...
print ls.cookies.get_dict()
print login_session.get(HOME_URL).url
print requests.get(HOME_URL, cookies=my_cookie).url
