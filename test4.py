...
body = session.get('https://testerhome.com/topics/4137')
response = HtmlResponse(url='https://testerhome.com/topics/4137')
...
for sel in Selector(text=body.text).xpath('//div[contains(@class, "infos")]'):
    print '========================================================='
    #reply_author
    print sel.xpath('div[contains(@class, info)]/span[contains(@class, "name")]/a/@data-name').extract()[0]
    #reply_time
    print sel.xpath('div[contains(@class, info)]/span[contains(@class, "time")]/abbr/@title').extract()[0]
    #reply_like
    print sel.xpath('div[contains(@class, info)]/span[contains(@class, "opts pull-right")]/a[contains(@class, "likeable")]/@data-count').extract()[0]
    #reply_body
    reply_body = ''
